            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex justify-center md:justify-start gap-3">
                  <a href="https://github.com/Muqeetahmedsolangi" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-200 rounded-lg flex items-center justify-center hover:bg-orange-500 transition-colors">
                    <svg className="w-5 h-5 text-gray-700 hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
