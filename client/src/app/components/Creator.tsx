            ...
            <div className="flex-1 text-center lg:text-left w-full">
              ...
              <div className="flex justify-center lg:justify-start gap-2 sm:gap-3">
                <a 
                  ...
                  className="group relative w-11 h-11 sm:w-12 sm:h-12 bg-gray-900 rounded-lg flex items-center justify-center hover:bg-gray-800 transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
